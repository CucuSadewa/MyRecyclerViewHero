...
public class HeroesData {
    ...
    private static int[] heroesImage = {
    ...
    static ArrayList<Hero> getListData() {
        ...
        for (int position = 0; position < heroesName.length; position++) {
            Hero hero = new Hero();
            hero.setName(heroesName[position]);
            hero.setPhoto(heroesImage[position]);
